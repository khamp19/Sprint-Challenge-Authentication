...
They show that a user is logged in without having to send login info with every page request

2. What does bcrypt do to help us store passwords in a secure manner. 

bcrypt hashes passwords so if they are stolen, they cannot be used

3. What does bcrypt do to slow down attackers?

bcrypt has a time component which prevents too many logins by a user in an amt of time
